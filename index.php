...
<head>
    ...
    <!-- 
        ...
        @logo    cdn.airve.com/logo/css3base/
    -->
    ...
    <style>
        body { max-width:1020px; width:98%; padding:0 1% }
    ...
    <header id="header">
        <h1>
            <a href="http://css3base.com" accesskey="1" rel="home">
                <img id="logo" src="http://cdn.airve.com/logo/css3base/300/css3base_logo_red_300.png" alt="css3base">
            </a>
        </h1>
    </header>
    ...
    <footer id="footer">
        <nav>
            <ul>
                ...
                <li><a href="/css/" title="css index" accesskey=i><b>/css</b></a>
                ...
                <li><a href="https://github.com/ryanve/css3base/issues" title="report an issue" accesskey=9>Issue?</a>
                <li class="visuallyhidden"><a accesskey=x href="http://html5.validator.nu/?doc=http://css3base.com">validate</a>
                <li class="visuallyhidden"><a id="end" href="#end" title="down" accesskey=z>&#9660;</a>
            </ul>
        </nav>
    </footer>
